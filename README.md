...
5. Create a new script within scriptable using source code from this [pseudo-transparent script](https://github.com/thewaytozion/widgets/blob/main/Inzidenz-COVID-19.js "pseudo-transparent script")
