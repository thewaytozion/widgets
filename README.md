...
4. Run script from point 2, follow script guideline and export to FILE at end of script, save it to "Scriptable" iCloud-folder (or subfolder). Remember folder and image file name!
### Sources/Credits: ###
